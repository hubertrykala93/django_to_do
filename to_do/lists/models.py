...
class Category(models.Model):
    user = models.ForeignKey(to=User, on_delete=models.CASCADE, default='', null=False)
    category = models.CharField(max_length=100, unique=False, blank=False, null=False)
